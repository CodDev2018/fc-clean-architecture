...
import SendEmailWhenProductIsCreatedHandler from '../../product/event/handler/send-email-when-product-is-created.hander';
import ProductCreatedEvent from '../../product/event/product-created.event';
import Log1WhenCustomerIsCreatedHandler from '../../customer/event/handler/log1-when-custumer-is-created.handler';
import Log2WhenCustomerIsCreatedHandler from '../../customer/event/handler/log2-when-custumer-is-created.handler';
import CustomerCreatedEvent from '../../customer/event/customer-created.event';
import LogWhenCustomerAddressUpdatedHandler from '../../customer/event/handler/log-when-custumer-address-is-updated.handler';
